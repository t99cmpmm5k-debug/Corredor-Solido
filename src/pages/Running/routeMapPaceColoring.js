...
export function buildKmMarkers(routeTrace) {
    ...
    for (let km = 1; km * KM_METERS <= total + 0.5; km++) {
        ...
        // -1: el margen de +0.5m de arriba deja pasar un target que supera
        // por una fracción a la distancia real total -- esa marca cae
        // pegada al último punto real, no al principio de la traza.
